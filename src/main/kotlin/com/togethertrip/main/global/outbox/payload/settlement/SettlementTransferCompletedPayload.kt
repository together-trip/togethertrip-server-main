...
data class SettlementTransferCompletedPayload(
    ...
    override fun withRecipients(recipients: List<DefaultOutboxRecipientPayload>): SettlementTransferCompletedPayload =
