...
4. 변경 전 필요한 경우 작업자별 계획 디렉터리(`docs/work-plans-<owner>/`)에 작업 계획을 남긴다.
...
- 공용 산출물 디렉터리(`docs/work-plans/`, `docs/reviews/`, `docs/verifications/`, `docs/handoffs/`)에 직접 쓰지 않고 작업자별 네임스페이스 디렉터리(`docs/work-plans-<owner>/` 등)를 사용한다.
